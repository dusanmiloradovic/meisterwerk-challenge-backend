...
export const GET_ALL_EVENTS =
  'select events_id,title,start_time,end_time,status,a.address from events e, addresses a where a.address_id=e.address_id'; //limit records for the demo only July
...
export const GET_EVENTS_RANGE =
  'select events_id,title,start_time,end_time, status,a.address from events e, addresses a where a.address_id=e.address_id and start_time between ? and ?';
